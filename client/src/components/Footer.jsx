            ...
            <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-8 sm:py-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
                    ...
                    <div className="sm:col-span-2 md:col-span-1">
                        <h3 className="text-xl sm:text-2xl font-bold text-red-500 mb-0 sm:mb-4">🧑🏻‍🍳 Aahare Bangla</h3>
                    ...
                    {/* Contact */}
                    <div>
                        <h4 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 hidden sm:block">Contact Us</h4>
                    ...
                    {/* Social Media */}
                    <div>
                        <h4 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 hidden sm:block">Follow Us</h4>
                        ...
                        <div className="mt-4 sm:mt-6">
                            <p className="text-gray-400 text-xs sm:text-sm mb-2 sm:mb-3">Opening Hours:</p>
