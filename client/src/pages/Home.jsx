        ...
        <div className="min-h-screen">
            ...
            <section className="relative h-[600px] md:h-[700px] overflow-hidden" data-testid="hero-section">
                ...
                <div className="absolute inset-0">
                    ...
                    <div className="absolute top-20 right-20 w-32 h-32 bg-red-500/10 rounded-full blur-3xl animate-pulse-soft"></div>
                    <div className="absolute bottom-40 right-40 w-48 h-48 bg-yellow-500/10 rounded-full blur-3xl animate-pulse-soft"></div>
                </div>
                        ...
                        <div className="max-w-2xl">
                            ...
                            <div className="flex flex-wrap gap-4">
                                <Link
                                    ...
                                    className="inline-flex items-center space-x-2 bg-linear-to-r from-red-500 to-red-600 text-white px-10 py-4 rounded-2xl font-bold text-lg hover:shadow-2xl hover:shadow-red-500/50 transition-all hover:scale-105"
                                >
                                    <span>Order Now</span>
                                ...
                                <Link
                                    to="/services"
                                    className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-md border-2 border-white/30 text-white px-10 py-4 rounded-2xl font-bold text-lg hover:bg-white/20 transition-all"
                                >
            ...
            {/* Stats Section - NEW */}
            <section className="bg-linear-to-r from-red-500 to-red-600 py-12 -mt-1">
            ...
            {/* Popular Categories */}
            <section className="py-20 bg-red-50" data-testid="categories-section">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                            What's on your mind <span className='text-red-600'>?</span>
                        </h2>
                        <p className="text-gray-600 text-xl">Browse our popular categories</p>
                    </div>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        {[
                            ...
                            <Link
                                ...
                                className="relative bg-white border-2 border-red-300/30 hover:border-red-500 p-10 rounded-3xl text-center font-bold transition-all hover:shadow-2xl hover:-translate-y-2 group overflow-hidden"
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="text-6xl mb-4 transform group-hover:scale-125 group-hover:rotate-12 transition-all duration-300">{category.emoji}</div>
                                    <div className="text-xl text-gray-800 group-hover:text-red-600 transition-colors font-bold">{category.name}</div>
                                </div>
                            </Link>
                        ))}
                    </div>
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-600 text-xl">Three simple steps to delicious food</p>
                    </div>
                    <div className="grid md:grid-cols-3 gap-8">
                        {steps.map((step, index) => (
                            <div key={index} className="relative">
                                ...
                                <div className="relative bg-linear-to-br from-gray-50 to-white p-8 rounded-3xl border-2 border-red-300/30 hover:border-red-500 hover:shadow-2xl transition-all group">
                                    {/* Step Number */}
                                    <div className="absolute -top-6 -left-6 w-16 h-16 bg-linear-to-br from-red-600 to-red-700 text-white rounded-2xl flex items-center justify-center font-bold text-xl shadow-lg group-hover:scale-110 transition-transform">
                                        {step.number}
                                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div className="order-2 md:order-1">
                            ...
                            <Link
                                to="/menu"
                                className="inline-flex items-center space-x-2 bg-linear-to-r from-red-600 to-red-700 text-white px-8 py-4 rounded-2xl font-bold hover:shadow-2xl hover:shadow-red-500/40 transition-all hover:scale-105"
                            >
                        ...
                        <div className="order-1 md:order-2 relative">
                            {/* Decorative elements */}
                            <div className="absolute -top-6 -right-6 w-32 h-32 bg-red-500/10 rounded-full blur-3xl"></div>
                            <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-yellow-500/10 rounded-full blur-3xl"></div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {features.map((feature, index) => (
                            <div
                                key={index}
                                className="relative bg-linear-to-br from-white to-gray-50 p-8 rounded-3xl shadow-md hover:shadow-2xl transition-all text-center group border-2 border-gray-100 hover:border-red-500 hover:-translate-y-2"
                                data-testid={`feature-${index}`}
                            >
                                {/* Gradient overlay on hover */}
                                <div className="absolute inset-0 bg-linear-to-br from-red-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-3xl"></div>
                                
                                <div className="relative z-10">
                                    <div className="inline-flex items-center justify-center w-20 h-20 bg-linear-to-br from-red-500 to-red-600 text-white rounded-2xl mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all shadow-lg">
                                        {feature.icon}
                                    </div>
            ...
            <section className="py-20 bg-red-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-600 text-xl">Join thousands of satisfied food lovers <span className='text-red-600'>...</span></p>
                    </div>
                    <div className="grid md:grid-cols-3 gap-8">
                        {testimonials.map((testimonial, index) => (
                            <div key={index} className="bg-white p-8 rounded-3xl shadow-md hover:shadow-2xl transition-all border-2 border-gray-100 hover:border-red-500">
                                {/* Stars */}
                                ...
                                {/* Comment */}
                                <p className="text-gray-700 mb-6 leading-relaxed text-lg">"{testimonial.comment}"</p>
                                
                                {/* Author */}
                                <div className="flex items-center gap-3">
                                    <div className="w-12 h-12 bg-linear-to-br from-red-500 to-red-600 rounded-full flex items-center justify-center text-2xl">
                                        {testimonial.avatar}
                                    </div>
                                    <div>
            ...
            {/* CTA Section */}
            <section className="gradient-red text-white py-24" data-testid="cta-section">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="text-2xl mb-10 text-red-50 leading-relaxed">
                        ...
                        <div className="flex flex-wrap gap-4 justify-center">
                            <Link
                                ...
                                className="inline-flex items-center space-x-2 bg-white text-red-600 px-12 py-5 rounded-2xl font-bold text-xl hover:bg-red-50 transition-all shadow-2xl hover:scale-105"
                            >
                            ...
                            <Link
                                to="/cart"
                                className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm border-2 border-white/30 text-white px-12 py-5 rounded-2xl font-bold text-xl hover:bg-white/20 transition-all"
                            >
                                <span>View Cart</span>
                            </Link>
                        </div>
